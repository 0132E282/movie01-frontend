...
export default function AllCatalogRoute() {
  return (
    <MainLayout hideBreadcrumb={false}>
      <Navbar />
      <div>
        <Suspense fallback={<div className="p-10 text-text-muted text-center py-20 font-bold">Đang chuẩn bị danh sách phim...</div>}>
          <AllCatalogContent />
        </Suspense>
      </div>
    </MainLayout>
